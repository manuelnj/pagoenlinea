      ...
      <div class="col-md-4">
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <form id="frmVisaNet" action="http://localhost/pagoenlinea/index.php?ruta=finalizar&amount=<?php echo $amount; ?>&purchaseNumber=<?php echo $purchaseNumber ?>">
              <script src="<?php echo VISA_URL_JS ?>" data-sessiontoken="<?php echo $sesion; ?>" data-channel="web" data-merchantid="<?php echo VISA_MERCHANT_ID ?>" data-merchantlogo="https://blog.solutekcolombia.com/wp-content/uploads/2019/02/mastercard-new-logo-content-2019.jpg" data-purchasenumber="<?php echo $purchaseNumber; ?>" data-amount="<?php echo $amount; ?>" data-expirationminutes="5" data-timeouturl="https://pagoenlineacal.org.pe/"></script>
            </form>
          </div>
